...
class PegawaiResponse with _$PegawaiResponse {
  const factory PegawaiResponse({required bool success, required String message, required PegawaiData data}) = _PegawaiResponse;

  factory PegawaiResponse.fromJson(Map<String, dynamic> json) => _$PegawaiResponseFromJson(json);
}
...
class PegawaiData with _$PegawaiData {
  ...
  factory PegawaiData.fromJson(Map<String, dynamic> json) => _$PegawaiDataFromJson(json);
}
...
class ShiftKerja with _$ShiftKerja {
  ...
  factory ShiftKerja.fromJson(Map<String, dynamic> json) => _$ShiftKerjaFromJson(json);
}
...
class PresensiAktif with _$PresensiAktif {
  ...
  factory PresensiAktif.fromJson(Map<String, dynamic> json) => _$PresensiAktifFromJson(json);
}
...
extension PresensiAktifExtension on PresensiAktif {
  ...
  String? get jamPulangFormatted {
    if (jamPulang!.isEmpty || jamPulang == 'null') return null;
  ...
  String _formatTimeString(String dateTimeString) {
    try {
      ...
      return dateTimeString.length > 8 ? dateTimeString.substring(0, 8) : dateTimeString;
    }
  }
}
